...
void main() {
  group('Testing App', () {
    ...
    // menghubungkan aplikasi ke driver yg
    // dijalankan sebelum skenario test dibuat.
    setUpAll(() async {
      driver = await FlutterDriver.connect();
    });

    // menutup koneksi antara aplikasi dan driver yg
    // dijalankan sesudah skenario tes dibuat.
    tearDownAll(() async {
      await driver.close();
    });
